...
use romanprojekt\Models\Feusers,
    romanprojekt\Controllers\ControllerBase as controllerBase;
...
class Auth extends Component
{
    ...
    {	
        ...
        $user = Feusers::findFirst(array(
            'conditions'=>'deleted=0 AND hidden=0 AND username=?1',
            'bind'=>array(
        ...
        if ($this->checkPassword($user->password,$credentials['password'])) {
            ...
            $this->flashSession->success('Grüße Erdling');
